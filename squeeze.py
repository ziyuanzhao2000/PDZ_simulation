...
pdb = PDBFile("DHFR_MnSAD_prepped.pdb")
mdsystem = mdtools.LatticeMDSystem(pdb.topology, pdb.positions, forcefield, "P 21 21 21")
mdsystem.buildSuperCell(3, 2, 1)
mdsystem.addSolvent(neutralize=True, positiveIon="Mn2+")
